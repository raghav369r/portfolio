  ...
  return (
    <div id="about" className="font-customFont">
      ...
      <div className="flex-row md:flex justify-center m-10 items-center">
        <div className="gap-8 size-80  hidden md:flex">
      ...
      <div className="flex flex-wrap justify-center gap-5 md:gap-14">
        {skills.map((ele, ind) => (
          <div key={ind} className="flex-row flex-nowrap w-52 my-5 md:my-10  transform cursor-pointer hover:scale-110">
